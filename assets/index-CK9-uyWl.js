...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ii,depthTest:!1,depthWrite:!1})}function pu(){return new oi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ql(),fragmentShader:`
		...
		`,blending:ii,depthTest:!1,depthWrite:!1})}function mu(){return new oi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ql(),fragmentShader:`
...
`].filter(Is).join(`
`)),o=dl(o),o=Au(o,e),o=wu(o,e),a=dl(a),a=Au(a,e),a=wu(a,e),o=Ru(o),a=Ru(a),e.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+f);const b=w+m+o,E=w+f+a,U=yu(s,s.VERTEX_SHADER,b),D=yu(s,s.FRAGMENT_SHADER,E);s.attachShader(x,U),s.attachShader(x,D),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function P(L){if(n.debug.checkShaderErrors){const it=s.getProgramInfoLog(x).trim(),$=s.getShaderInfoLog(U).trim(),rt=s.getShaderInfoLog(D).trim();let lt=!0,I=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(lt=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,U,D);else{const X=bu(s,U,"vertex"),N=bu(s,D,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
